...
🏠 Home Page
The entry point showcasing RouteWeaver’s minimal and elegant design. Home Page

🔐 Login / Signup
Secure authentication and user access. Login Page

🗺️ Query Page
Generate custom routes based on your interests, start/destination, and trip preferences. Query Page

💾 Saved Routes
Access your previously planned or completed journeys. Saved Routes

🌴 SmartVacay
AI-driven vacation planner that syncs with your calendar to suggest travel windows. SmartVacay

💡 Suggestions Page
Get intelligent recommendations for places to visit based on interest keywords. Suggestions Page

✈️ Travel Packages
Explore pre-built optimized travel packages near your current location. Travel Packages
